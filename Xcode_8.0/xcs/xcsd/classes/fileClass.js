...
XCSFileClass.prototype.downloadIntegrationArchive = function downloadIntegrationArchive(req, res, next) {
    ...
    async.waterfall([
        ...
        function FIDownloadIntegrationArchiveCompress(filename, callback, cb) {
            ...
            execFile('/usr/bin/tar', ['-cf', filename, '-C', path.dirname(fullPath), '-s', `/${basename}/${renamedDirectory}/`, basename], function FIDownloadIntegrationArchiveCompressCallback(err) {
                if (err) {
