...
handlebars.registerHelper('issue_summary', function(integration, issueAuthor, hostname) {
    ...
    getIssueTypesProjectNamesAndCommitShasFromIssues(issueAuthor.issues, issueAuthor.issueIdsWithHighStrategy, highProjectNames, issueTypes, highCommitShas, highestStrategyFound);
    ...
    if (issueTypes.error > 0 && issueTypes.warning > 0 && issueTypes.analyzerWarning === 0) {
    ...
    if (issueTypes.warning > 0 && issueTypes.analyzerWarning > 0) {
        issuesTypeString += " and ";
    }
