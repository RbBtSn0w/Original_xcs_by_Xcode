...
module.exports = {
    ...
    XCSHTTPPort: 20300,
    XCSHTTPSPort: 20343,
    XCSAppDashboardWebSocketsPort: 20398,
    ...
    // Redis
    XCSRedisSocket: '/Library/Developer/XcodeServer/Database/redis.sock',
    ...
    // Pruning
    XCSPruningIsActive: 'XCSPruningIsActive',
    XCSPruningInterval: 60 * 60 * 1000, // Every hour
    ...
    XCS_SSL_SERVER_CERT_EMAIL_USER: 'xcsd',
