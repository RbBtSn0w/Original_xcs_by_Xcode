...
'getenc_PBMAC1-MACs'/2,
'getenc_PBMAC1-KDFs'/2,
'getenc_PBMAC1Algorithms'/2,
'getenc_PBES2-Encs'/2,
'getenc_PBES2-KDFs'/2,
'getenc_PBES2Algorithms'/2,
'getenc_PBES1Algorithms'/2,
'getenc_PBKDF2-PRFs'/2,
'getenc_PBKDF2-SaltSources'/2,
...
'getdec_PBMAC1-MACs'/2,
'getdec_PBMAC1-KDFs'/2,
'getdec_PBMAC1Algorithms'/2,
'getdec_PBES2-Encs'/2,
'getdec_PBES2-KDFs'/2,
'getdec_PBES2Algorithms'/2,
'getdec_PBES1Algorithms'/2,
'getdec_PBKDF2-PRFs'/2,
'getdec_PBKDF2-SaltSources'/2,
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_1'(id, Term1),
Term2 = 
   case Tmpterm1 of
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_2'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_3'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_4'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_5'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_6'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
ObjcontextType = 
   'PKCS-FRAME':'getenc_SupportedContexts'(id, 
                                   Cindex1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1,[6]),
ObjFun = 'PKCS-FRAME':'getdec_SupportedContexts'(id, Term1),
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_7'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1,[6]),
ObjFun = 'PKCS-FRAME':'getdec_internal_object_set_argument_8'(id, Term1),
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_9'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
%%================================
'getenc_SupportingAlgorithms'(id,{1,2,840,113549,2,7}) ->
...
'getenc_SupportingAlgorithms'(id,{1,2,840,113549,3,2}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_RC2-CBC-Parameter'(Val)
...
'getenc_SupportingAlgorithms'(id,{1,2,840,113549,3,7}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
'getenc_SupportingAlgorithms'(id,{1,2,840,113549,3,9}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_RC5-CBC-Parameters'(Val)
...
'getdec_SupportingAlgorithms'(id,{1,2,840,113549,2,7}) ->
...
'getdec_SupportingAlgorithms'(id,{1,2,840,113549,3,2}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
'getdec_SupportingAlgorithms'(id,{1,2,840,113549,3,7}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
'getdec_SupportingAlgorithms'(id,{1,2,840,113549,3,9}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
%%  PBMAC1-KDFs
%%================================
'getenc_PBMAC1-KDFs'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBKDF2-params'(Val)
...
'getdec_PBMAC1-KDFs'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
%%  PBMAC1Algorithms
%%================================
'getenc_PBMAC1Algorithms'(id,{1,2,840,113549,1,5,14}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBMAC1-params'(Val)
...
'getdec_PBMAC1Algorithms'(id,{1,2,840,113549,1,5,14}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
%%  PBES2-KDFs
%%================================
'getenc_PBES2-KDFs'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBKDF2-params'(Val)
...
'getdec_PBES2-KDFs'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBKDF2-params'(Bytes)
...
%%  PBES2Algorithms
%%================================
'getenc_PBES2Algorithms'(id,{1,2,840,113549,1,5,13}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBES2-params'(Val)
...
'getdec_PBES2Algorithms'(id,{1,2,840,113549,1,5,13}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
%%  PBES1Algorithms
%%================================
'getenc_PBES1Algorithms'(id,{1,2,840,113549,1,5,1}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBEParameter'(Val)
...
'getenc_PBES1Algorithms'(id,{1,2,840,113549,1,5,3}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBEParameter'(Val)
...
'getenc_PBES1Algorithms'(id,{1,2,840,113549,1,5,4}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBEParameter'(Val)
...
'getenc_PBES1Algorithms'(id,{1,2,840,113549,1,5,6}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBEParameter'(Val)
...
'getenc_PBES1Algorithms'(id,{1,2,840,113549,1,5,10}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBEParameter'(Val)
...
'getenc_PBES1Algorithms'(id,{1,2,840,113549,1,5,11}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBEParameter'(Val)
...
'getdec_PBES1Algorithms'(id,{1,2,840,113549,1,5,1}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
...
'getdec_PBES1Algorithms'(id,{1,2,840,113549,1,5,3}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBEParameter'(Bytes)
...
'getdec_PBES1Algorithms'(id,{1,2,840,113549,1,5,4}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBEParameter'(Bytes)
...
'getdec_PBES1Algorithms'(id,{1,2,840,113549,1,5,6}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBEParameter'(Bytes)
...
'getdec_PBES1Algorithms'(id,{1,2,840,113549,1,5,10}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBEParameter'(Bytes)
...
'getdec_PBES1Algorithms'(id,{1,2,840,113549,1,5,11}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBEParameter'(Bytes)
...
%%================================
'getenc_internal_object_set_argument_6'(id,{1,2,840,113549,2,7}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            encode_null(Val, [<<5>>])
...
'getdec_internal_object_set_argument_6'(id,{1,2,840,113549,2,7}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            decode_null(Bytes,[5])
...
%%================================
'getenc_internal_object_set_argument_3'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBKDF2-params'(Val)
...
'getdec_internal_object_set_argument_3'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBKDF2-params'(Bytes)
...
%%================================
'getenc_internal_object_set_argument_1'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Val, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'enc_PBKDF2-params'(Val)
...
'getdec_internal_object_set_argument_1'(id,{1,2,840,113549,1,5,12}) ->
   fun(Type, Bytes, _RestPrimFieldName) ->
      case Type of
         'Type' ->
            'dec_PBKDF2-params'(Bytes)
