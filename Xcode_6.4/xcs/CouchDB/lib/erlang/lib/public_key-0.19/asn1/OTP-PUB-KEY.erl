%% Generated by the Erlang ASN.1 BER_V2-compiler version, utilizing bit-syntax:2.0.2
...
-asn1_info([{vsn,'2.0.2'},
 ...
 {cwd,"/SourceCache/XCSCouchDB/XCSCouchDB-1/dependencies/otp/lib/public_key/asn1"},
 {outdir,"/SourceCache/XCSCouchDB/XCSCouchDB-1/dependencies/otp/lib/public_key/asn1"},
 asn1config,noobj,compact_bit_string,der,
 {i,"."},
 {i,"/SourceCache/XCSCouchDB/XCSCouchDB-1/dependencies/otp/lib/public_key/asn1"}]}]).
...
'getenc_Authenticated'/2,
'getenc_Contents'/2,
'getenc_KeyEncryptionAlgorithms'/2,
'getenc_DigestEncryptionAlgorithms'/2,
'getenc_DigestAlgorithms'/2,
'getenc_ContentEncryptionAlgorithms'/2,
'getenc_SignatureAlgorithms'/2,
'getenc_CRIAttributes'/2,
'getenc_PKInfoAlgorithms'/2,
...
'getdec_Authenticated'/2,
'getdec_Contents'/2,
'getdec_KeyEncryptionAlgorithms'/2,
'getdec_DigestEncryptionAlgorithms'/2,
'getdec_DigestAlgorithms'/2,
'getdec_ContentEncryptionAlgorithms'/2,
'getdec_SignatureAlgorithms'/2,
'getdec_CRIAttributes'/2,
'getdec_PKInfoAlgorithms'/2,
...
'enc_SignerInfo_authenticatedAttributes_aaSet_components'([H|T],AccBytes, AccLen) ->
   {EncBytes,EncLen} = 'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(H, [<<48>>]),
...
%%================================
'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(Val, TagIn) ->
   {_,Cindex1, Cindex2} = Val,
Objtype = 
...
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(Cindex2, [<<49>>], Objtype),
...
%%================================
'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(Val, TagIn, ObjFun) ->
      {EncBytes,EncLen} = 'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'(Val, ObjFun,[],0),
   encode_tags(TagIn, EncBytes, EncLen).

'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'([], _, AccBytes, AccLen) -> 
   {dynamicsort_SETOF(AccBytes),AccLen};

'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'([H|T], ObjFun,AccBytes, AccLen) ->
   {TmpBytes1,_} = ObjFun('Type', H, []),
   {EncBytes,EncLen} = encode_open_type(TmpBytes1, [])
,
   'enc_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values_components'(T, ObjFun,[EncBytes|AccBytes], AccLen + EncLen).

'dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(Tlv, TagIn, ObjFun) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
'dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(Tlv, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1,[6]),
ObjFun = 'OTP-PUB-KEY':'getdec_internal_object_set_argument_4'(id, Term1),

%%-------------------------------------------------
%% attribute values(2) with type SET OF
%%-------------------------------------------------
[V2|Tlv3] = Tlv2, 
Term2 = 'dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7_values'(V2, [17], ObjFun),
...
'dec_SignerInfo_authenticatedAttributes_aaSet'(Tlv, TagIn) ->
   ...
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
['dec_SignerInfo_authenticatedAttributes_aaSet_AttributePKCS-7'(V1, [16]) || V1 <- Tlv1].
...
'enc_SignerInfo_authenticatedAttributes_aaSequence_components'([H|T],AccBytes, AccLen) ->
   {EncBytes,EncLen} = 'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(H, [<<48>>]),
...
%%================================
'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(Val, TagIn) ->
   {_,Cindex1, Cindex2} = Val,
Objtype = 
...
%% attribute values(2) with type SET OF
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(Cindex2, [<<49>>], Objtype),
...
%%================================
'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(Val, TagIn, ObjFun) ->
      {EncBytes,EncLen} = 'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'(Val, ObjFun,[],0),
   encode_tags(TagIn, EncBytes, EncLen).

'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'([], _, AccBytes, AccLen) -> 
   {dynamicsort_SETOF(AccBytes),AccLen};

'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'([H|T], ObjFun,AccBytes, AccLen) ->
   {TmpBytes1,_} = ObjFun('Type', H, []),
   {EncBytes,EncLen} = encode_open_type(TmpBytes1, [])
,
   'enc_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values_components'(T, ObjFun,[EncBytes|AccBytes], AccLen + EncLen).

'dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(Tlv, TagIn, ObjFun) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
'dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(Tlv, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1,[6]),
ObjFun = 'OTP-PUB-KEY':'getdec_internal_object_set_argument_5'(id, Term1),

%%-------------------------------------------------
%% attribute values(2) with type SET OF
%%-------------------------------------------------
[V2|Tlv3] = Tlv2, 
Term2 = 'dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7_values'(V2, [17], ObjFun),
...
'dec_SignerInfo_authenticatedAttributes_aaSequence'(Tlv, TagIn) ->
   ...
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
['dec_SignerInfo_authenticatedAttributes_aaSequence_AttributePKCS-7'(V1, [16]) || V1 <- Tlv1].
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1,[6]),
ObjFun = 'OTP-PUB-KEY':'getdec_internal_object_set_argument_7'(id, Term1),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1,[6]),
ObjFun = 'OTP-PUB-KEY':'getdec_internal_object_set_argument_8'(id, Term1),
...
{_,Cindex1, Cindex2} = Val,
ObjcontentType = 
   'OTP-PUB-KEY':'getenc_Contents'(id, 
                                   Cindex1),
...
%%-------------------------------------------------
   ...
   {TmpBytes1,TmpLen} = encode_open_type(TmpBytes, [<<160>>]),
   {TmpBytes1, TmpLen}
       end,
...
%%-------------------------------------------------
   ...
   {TmpBytes1,TmpLen} = encode_open_type(TmpBytes, []),
   {TmpBytes1, TmpLen}
       end,
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_3'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_6'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_2'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_1'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_11'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_9'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1,[6]),
ObjFun = 'OTP-PUB-KEY':'getdec_internal_object_set_argument_10'(id, Term1),
...
{_,Cindex1, Cindex2, Cindex3} = Val,
ObjextnID = 
   'OTP-PUB-KEY':'getenc_SupportedExtensions'(id, 
                                   Cindex1),
...
%%-------------------------------------------------
   ...
   {EncBytes2,EncLen2} = encode_open_type(TmpBytes1, [<<161>>])
,
...
DecObjextensionAttributeTypeTerm1 =
   'OTP-PUB-KEY':'getdec_SupportedExtensionAttributes'(id, Term1),
Term2 = 
...
DecObjbasisTerm2 =
   'OTP-PUB-KEY':'getdec_SupportedCharacteristicTwos'(id, Term2),
Term3 = 
...
{_,Cindex1, Cindex2} = Val,
ObjfieldType = 
   'OTP-PUB-KEY':'getenc_SupportedFieldIds'(id, 
                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_SupportedPublicKeyAlgorithms'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_SupportedSignatureAlgorithms'(id, Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_SupportedPublicKeyAlgorithms'(id, element(2,Term1)),
Term2 = 
...
DecObjtypeTerm1 =
   'OTP-PUB-KEY':'getdec_SupportedAttributeTypeAndValues'(id, Term1),
Term2 = 
...
%%  Unauthenticated
%%================================
'getenc_Unauthenticated'(id,{1,2,840,113549,1,9,3}) ->
    fun 'enc_contentType'/3;
'getenc_Unauthenticated'(id,{1,2,840,113549,1,9,6}) ->
    fun 'enc_counterSignature'/3;
'getenc_Unauthenticated'(id,{1,2,840,113549,1,9,4}) ->
...
'getdec_Unauthenticated'(id,{1,2,840,113549,1,9,3}) ->
    fun 'dec_contentType'/3;
'getdec_Unauthenticated'(id,{1,2,840,113549,1,9,6}) ->
    fun 'dec_counterSignature'/3;
'getdec_Unauthenticated'(id,{1,2,840,113549,1,9,4}) ->
...
%%  Authenticated
%%================================
'getenc_Authenticated'(id,{1,2,840,113549,1,9,3}) ->
    fun 'enc_contentType'/3;
'getenc_Authenticated'(id,{1,2,840,113549,1,9,4}) ->
    fun 'enc_messageDigest'/3;
'getenc_Authenticated'(id,{1,2,840,113549,1,9,5}) ->
...
'getdec_Authenticated'(id,{1,2,840,113549,1,9,3}) ->
    fun 'dec_contentType'/3;
'getdec_Authenticated'(id,{1,2,840,113549,1,9,4}) ->
    fun 'dec_messageDigest'/3;
'getdec_Authenticated'(id,{1,2,840,113549,1,9,5}) ->
...
'getenc_SupportedSignatureAlgorithms'(id,{1,3,14,3,2,27}) ->
    fun 'enc_dsaWithSHA1'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,1}) ->
    fun 'enc_ecdsa-with-sha1'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,1}) ->
    fun 'enc_ecdsa-with-sha224'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,2}) ->
    fun 'enc_ecdsa-with-sha256'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,3}) ->
    fun 'enc_ecdsa-with-sha384'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,4}) ->
...
'getenc_SupportedSignatureAlgorithms'(id,{1,3,14,3,2,29}) ->
...
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,14}) ->
    fun 'enc_sha224-with-rsa-encryption'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,11}) ->
    fun 'enc_sha256-with-rsa-encryption'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,12}) ->
    fun 'enc_sha384-with-rsa-encryption'/3;
'getenc_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,13}) ->
...
'getdec_SupportedSignatureAlgorithms'(id,{1,3,14,3,2,27}) ->
    fun 'dec_dsaWithSHA1'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,1}) ->
    fun 'dec_ecdsa-with-sha1'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,1}) ->
    fun 'dec_ecdsa-with-sha224'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,2}) ->
    fun 'dec_ecdsa-with-sha256'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,3}) ->
    fun 'dec_ecdsa-with-sha384'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,10045,4,3,4}) ->
...
'getdec_SupportedSignatureAlgorithms'(id,{1,3,14,3,2,29}) ->
...
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,14}) ->
    fun 'dec_sha224-with-rsa-encryption'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,11}) ->
    fun 'dec_sha256-with-rsa-encryption'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,12}) ->
    fun 'dec_sha384-with-rsa-encryption'/3;
'getdec_SupportedSignatureAlgorithms'(id,{1,2,840,113549,1,1,13}) ->
...
%%================================
'getenc_internal_object_set_argument_8'(id,{1,2,840,113549,1,9,3}) ->
    fun 'enc_contentType'/3;
'getenc_internal_object_set_argument_8'(id,{1,2,840,113549,1,9,6}) ->
    fun 'enc_counterSignature'/3;
'getenc_internal_object_set_argument_8'(id,{1,2,840,113549,1,9,4}) ->
    fun 'enc_messageDigest'/3;
...
'getdec_internal_object_set_argument_8'(id,{1,2,840,113549,1,9,3}) ->
    fun 'dec_contentType'/3;
'getdec_internal_object_set_argument_8'(id,{1,2,840,113549,1,9,6}) ->
    fun 'dec_counterSignature'/3;
'getdec_internal_object_set_argument_8'(id,{1,2,840,113549,1,9,4}) ->
    fun 'dec_messageDigest'/3;
...
%%================================
'getenc_internal_object_set_argument_7'(id,{1,2,840,113549,1,9,3}) ->
    fun 'enc_contentType'/3;
'getenc_internal_object_set_argument_7'(id,{1,2,840,113549,1,9,6}) ->
    fun 'enc_counterSignature'/3;
'getenc_internal_object_set_argument_7'(id,{1,2,840,113549,1,9,4}) ->
    fun 'enc_messageDigest'/3;
...
'getdec_internal_object_set_argument_7'(id,{1,2,840,113549,1,9,3}) ->
    fun 'dec_contentType'/3;
'getdec_internal_object_set_argument_7'(id,{1,2,840,113549,1,9,6}) ->
    fun 'dec_counterSignature'/3;
'getdec_internal_object_set_argument_7'(id,{1,2,840,113549,1,9,4}) ->
    fun 'dec_messageDigest'/3;
...
%%================================
'getenc_internal_object_set_argument_5'(id,{1,2,840,113549,1,9,3}) ->
    fun 'enc_contentType'/3;
'getenc_internal_object_set_argument_5'(id,{1,2,840,113549,1,9,4}) ->
    fun 'enc_messageDigest'/3;
'getenc_internal_object_set_argument_5'(id,{1,2,840,113549,1,9,5}) ->
    fun 'enc_signingTime'/3;
...
'getdec_internal_object_set_argument_5'(id,{1,2,840,113549,1,9,3}) ->
    fun 'dec_contentType'/3;
'getdec_internal_object_set_argument_5'(id,{1,2,840,113549,1,9,4}) ->
    fun 'dec_messageDigest'/3;
'getdec_internal_object_set_argument_5'(id,{1,2,840,113549,1,9,5}) ->
    fun 'dec_signingTime'/3;
...
%%================================
'getenc_internal_object_set_argument_4'(id,{1,2,840,113549,1,9,3}) ->
    fun 'enc_contentType'/3;
'getenc_internal_object_set_argument_4'(id,{1,2,840,113549,1,9,4}) ->
    fun 'enc_messageDigest'/3;
'getenc_internal_object_set_argument_4'(id,{1,2,840,113549,1,9,5}) ->
    fun 'enc_signingTime'/3;
...
'getdec_internal_object_set_argument_4'(id,{1,2,840,113549,1,9,3}) ->
    fun 'dec_contentType'/3;
'getdec_internal_object_set_argument_4'(id,{1,2,840,113549,1,9,4}) ->
    fun 'dec_messageDigest'/3;
'getdec_internal_object_set_argument_4'(id,{1,2,840,113549,1,9,5}) ->
    fun 'dec_signingTime'/3;
