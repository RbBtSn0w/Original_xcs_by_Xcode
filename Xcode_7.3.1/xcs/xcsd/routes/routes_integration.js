...
//router.get('/integrations', prepareRequest, enforceBotViewerRole, integration.list);
...
// Bot Integrations
router.post('/bots/:id/integrations', prepareRequest, enforceBotViewerRole, setTTLInDocumentIfNeeded, integration.create);
