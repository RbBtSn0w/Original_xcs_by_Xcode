...
router.post('/debug/maintenance-tasks/fake-tasks', xcsutil.generateFakeMaintenanceTasks.bind(xcsutil));
router.post('/debug/init-phase/enable', xcsutil.enableManualInitPhase);
router.post('/debug/init-phase/disable', xcsutil.disableManualInitPhase);
