...
-asn1_info([{vsn,'2.0.4'},
 ...
 {cwd,"/System/Volumes/Data/SWE/Apps/DT/BuildRoots/BuildRoot2/ActiveBuildRoot/Library/Caches/com.apple.xbs/Sources/XCSCouchDB/XCSCouchDB-21.0.4/dependencies/otp/lib/public_key/asn1"},
 {outdir,"/System/Volumes/Data/SWE/Apps/DT/BuildRoots/BuildRoot2/ActiveBuildRoot/Library/Caches/com.apple.xbs/Sources/XCSCouchDB/XCSCouchDB-21.0.4/dependencies/otp/lib/public_key/asn1"},
 asn1config,noobj,compact_bit_string,der,
 {i,"."},
 {i,"/System/Volumes/Data/SWE/Apps/DT/BuildRoots/BuildRoot2/ActiveBuildRoot/Library/Caches/com.apple.xbs/Sources/XCSCouchDB/XCSCouchDB-21.0.4/dependencies/otp/lib/public_key/asn1"}]}]).
...
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case catch check_named_bitstring([unclassified], Cindex2, [{unmarked,0},{unclassified,1},{restricted,2},{confidential,3},{secret,4},{topSecret,5}]) of
            true -> {[],0};
         _ ->
...
%% 'ia5String'
    {22, V1} -> 
        {ia5String, decode_restricted_string(V1,{1,255},[])};
